...
export const AlertIcon: React.FC<TickIconProps> = ({ color, h, w }) => (
    <svg className="w-4 h-4" height={h} width={w} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
