    ...
    <div className="p-8 min-h-screen">
      ...
      <div className="grid grid-cols-[1.2fr_auto_1fr] gap-16 relative">
        ...
        {/* <div className="flex flex-col items-center justify-center gap-4 relative">
              <div className="bg-[#151825] rounded-lg p-2 flex flex-col gap-2">
                <div className="w-10 h-10 bg-[#1D1F2E] rounded-lg flex items-center justify-center">
                  <WindowIcon />
                </div>
                <div className="w-10 h-10 bg-[#1D1F2E] rounded-lg flex items-center justify-center">
                  <PlaneIcon />
        ...
        {/* Loading spinner */}
        {/* <div className="w-10 h-10 rounded-full border-2 border-[#4F6BFF] border-t-transparent animate-spin"></div> */}
        {/* Down arrow */}
        {/* <div className="absolute -bottom-16 left-1/2 transform -translate-x-1/2">
          <svg width="24" height="60" viewBox="0 0 24 60" fill="none">
            <path d="M12 0V56M12 56L2 46M12 56L22 46" stroke="#4F6BFF" strokeWidth="2" />
          </svg>
        </div> */}
      </div>
      ...
      {/* <div className="space-y-8">
        ...
        <AlertSummary
          ...
          count={3}
          icon={<ThreatIcon />}
          iconStrip={<IconStrip count={3} />}
        />
      </div> */}

      {/* Connecting Lines */}
      {/* <div className="absolute left-[28%] top-1/2 transform -translate-y-1/2 w-[15%] h-[2px] bg-[#4F6BFF]">
        <div className="absolute right-0 top-1/2 transform translate-x-1/2 -translate-y-1/2 w-3 h-3 border-t-2 border-r-2 border-[#4F6BFF] rotate-45"></div>
      </div>
      <div className="absolute right-[28%] top-1/2 transform -translate-y-1/2 w-[15%] h-[2px] bg-[#4F6BFF]">
        <div className="absolute right-0 top-1/2 transform translate-x-1/2 -translate-y-1/2 w-3 h-3 border-t-2 border-r-2 border-[#4F6BFF] rotate-45"></div>
      </div>
    </div> */}
    </div >
